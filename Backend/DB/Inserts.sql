...
INSERT INTO productos (nombre, descripcion, contenido, precio, descuento, existencia, imagen, marca, animal_id, categoria_id) VALUES ('Hills Science Diet Adult 1-6', 'Alimento Premium para gatos', '7.2 kg', 1095.00, 0, 15, 'https://m.media-amazon.com/images/I/817mX8hi-VL._AC_SL1500_.jpg', 'Hills Science Diet', 2, 1);
INSERT INTO productos (nombre, descripcion, contenido, precio, descuento, existencia, imagen, marca, animal_id, categoria_id) VALUES ('Kisha', 'Alimento Seco Gato Adulto, Natural', '12 Kg', 799.00, 0, 8, 'https://m.media-amazon.com/images/I/41XmwctjaTL._AC_.jpg', 'GrandPet', 2, 1);
INSERT INTO productos (nombre, descripcion, contenido, precio, descuento, existencia, imagen, marca, animal_id, categoria_id) VALUES ('Bola para gatos', 'Juguete eléctrico para gatos es perfecto para que juegue tu gato.', '1 unidad', 152.00, 0, 18, 'https://m.media-amazon.com/images/I/61LvVMGMgnL._AC_SL1500_.jpg', 'Seasky', 2, 3);
INSERT INTO productos (nombre, descripcion, contenido, precio, descuento, existencia, imagen, marca, animal_id, categoria_id) VALUES ('Juguete caña con ratón', 'Juguete para gato en forma de caña de pescar elaborado con textiles naturales.', '1 unidad', 53.00, 0, 10, 'https://m.media-amazon.com/images/I/71bGgo4QPSL._AC_SL1500_.jpg', 'Seasky', 2, 3);

INSERT INTO ordenes (esta_pagado, usuario_id, fecha_pago ) VALUES (FALSE, 2, "2023-10-5");
INSERT INTO ordenes (esta_pagado, usuario_id, fecha_pago ) VALUES (FALSE, 3, "2020-11-15");
INSERT INTO ordenes (esta_pagado, usuario_id, fecha_pago ) VALUES (TRUE, 1, "2021-03-02");

INSERT INTO ordenes_has_productos ( orden_id, producto_id, cantidad) VALUES (2,2,2);
INSERT INTO ordenes_has_productos ( orden_id, producto_id, cantidad ) VALUES (1,3,3);

INSERT INTO comentarios ( fecha, comentario, calificacion, usuario_id, producto_id) VALUES ("2023-02-13","Muy bueno",5,2,3);